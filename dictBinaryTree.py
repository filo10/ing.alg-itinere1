# Codice modificato da Briscese Filippo Maria in riga 31
...
class DictBinaryTree:
    ...
    def maxKeySon(self, root):
        ...
        # Nuovo codice scritto da Filo
        if root == None:    # nell'usare dictLazyBST ho avuto dei proplemi del tipo: None non ha attributo rightSon...
            return None     # non ho approfondito il perche' di questo, visto che ho risolto semplicemente inserendo
                            # questo controllo...
        # Fine nuovo codice
        curr = root
